...
public class ShooterSubsystem extends SubsystemBase {
  ...
  private void configureAzimuthMotor() {
    ...
    cfg.closedLoop.positionWrappingEnabled(true);
    cfg.closedLoop.positionWrappingInputRange(0, 360);
    ...
    cfg.encoder.velocityConversionFactor(degreesPerRevolution / 60); // revolutions per minute to degrees per second

    // Send the configuration to the sparkmax
    azimuthMotor.configure(cfg, ResetMode.kNoResetSafeParameters, PersistMode.kPersistParameters);
